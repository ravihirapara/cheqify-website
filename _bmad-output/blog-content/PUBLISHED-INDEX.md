...
**Last synced from Sanity:** 2026-06-15
...
| 16 | 14 | `cheque-number-in-cheque-book-explained` | Cheque number in a cheque book explained — Where it ss, what It means, why it matters (2026) | Cheque Guide, Banking & RBI | FAQ |
| 17 | 15 | `cheque-clearing-time-india` | How long does a Cheque take to clear in india? (2026 CTS uide) | Banking & RBI, Cheque Guide | FAQ |
...
| 23 | 19 | `loan-repayment-by-cheque-india` | How to Repay a Loan by Cheque in India — EMI, Prepayment & Principal Reduction (2026) | Cheque Guide, Banking & RBI | FAQ |
| 24 | 19 | `how-to-write-cancelled-cheque-safely` |  How to write a cancelled Cheque safely — and why everyone keeps asking for one (2026) | Cheque Guide, Banking & RBI | FAQ |
| 25 | 20 | `how-to-request-cheque-book-online-india` | How to request a Cheque book online — SBI, HDFC, ICICI, Axis, Kotak (2026) | Cheque Guide, Cheque Productivity | FAQ |
| 26 | 20 | `demand-draft-vs-cheque-vs-bankers-cheque` | Demand draft vs Cheque vs Banker's Cheque — Which one to use, and when (2026) | Banking & RBI, Cheque Guide | FAQ |
...
|---|---|---|---|---|---|---|---|
| 23 | `crossed-cheque-vs-account-payee` | `post-23-crossed-cheque-vs-account-payee.md` | ⚠️ OVERDUE — slot was Mon 2026-06-08 | 1,886 | NO | 7 | **STILL NOT LIVE** as of 2026-06-15 even though #26 (now live) links to it in-body → that internal link currently 404s. Publish ASAP. Definitional deep-dive, complements post #18 (cheque types overview). |
...
- ❌ Loan repayment by cheque — EMI/prepayment (post #24)
- ❌ How to write a cancelled cheque safely (post #25)
- ❌ DD vs cheque vs banker's cheque (post #26)
- ❌ Request a cheque book online — SBI/HDFC/ICICI/Axis/Kotak (post #27)

⚠️ Drafted on disk but NOT live (overdue): crossed cheque vs account payee (post #23 — slot was 2026-06-08). #26 links to it in-body, so that link 404s until #23 is published.
