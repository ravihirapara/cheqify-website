...
The specific GST OTC threshold (₹10,000) and the rules around authorized bank lists, challan generation, and CIN issuance can shift via CBIC circular. Before publishing, verify the figures in this draft against:
...
3. A practising CA review — if the ₹10,000 cap has been revised or the authorized-bank list has changed.
...
- **EN:** Short answer: yes — but only over the counter at an authorized bank and only up to ₹10,000 per challan. Above the cap, GST payment requires NEFT, RTGS, net banking, or card. Full walkthrough of the OTC cheque mechanism, the CPIN challan flow, and why most businesses skip cheques for GST in 2026.
- **HI:** Short answer: हाँ — पर सिर्फ़ authorized bank पर over the counter और सिर्फ़ ₹10,000 per challan तक. Cap से ऊपर, GST payment के लिए NEFT, RTGS, net banking, या card चाहिए. OTC cheque mechanism, CPIN challan flow, और 2026 में ज़्यादातर businesses GST के लिए cheque skip क्यों करते हैं — full walkthrough.
- **GU:** Short answer: હા — પણ ફક્ત authorized bank પર over the counter અને ફક્ત ₹10,000 per challan સુધી. Cap થી ઉપર, GST payment માટે NEFT, RTGS, net banking, કે card જોઈએ. OTC cheque mechanism, CPIN challan flow, અને 2026 માં મોટાભાગના businesses GST માટે cheque કેમ skip કરે છે — full walkthrough.
...
### [H2] The Mode-of-Payment Picture on the GST Portal
...
### [H2] The ₹10,000 Cap (And What It Actually Means)
...
### [H2] How to Actually Pay GST by Cheque (OTC Walkthrough)
...
### [H2] Which Banks Are Authorized for GST Collection
...
### [H2] Why Most Businesses Skip the Cheque Route Anyway
...
### [H2] The Real Alternatives Above ₹10,000
...
### [H2] When Cheque-via-OTC Genuinely Helps
...
### [H2] Cheque Quality Still Matters for OTC
...
### [H2] The Compliance Closing Thought
...
> **Disclosure:** GST rules are issued and revised by CBIC via circular. Verify thresholds and authorized-bank lists on the GST portal before any actual payment. This article is informational and is not a substitute for advice from a practising chartered accountant.
...
| # | Name | Text |
|---|---|---|
| 1 | Generate a CPIN challan on gst.gov.in | Log in → Services → Payments → Create Challan. Enter the heads (CGST, SGST, IGST, Cess), select "Over the Counter" as the mode, choose an authorized bank from the dropdown. The system generates a 14-digit CPIN. |
...
| 4 | Walk into the chosen authorized bank's branch | Hand the printed challan and cheque to the GST collection counter. Tier-2/3 cities — confirm the branch handles GST collection before going. |
...
1. **Q:** Can I pay GST by cheque in India in 2026?
   **A:** Yes, but only through Over-the-Counter (OTC) mode at an authorized bank branch, and only for challans with total tax up to ₹10,000. Above that limit, the GST portal blocks OTC and requires net banking, NEFT/RTGS, or a card-based gateway payment.
...
6. **Q:** Which banks accept GST cheque payments?
   **A:** Most major scheduled commercial banks (SBI, HDFC, ICICI, Axis, PNB, Bank of Baroda, Canara, Union, IDBI, Kotak) plus authorized cooperative banks. The current full list appears on the GST portal during challan creation — only banks shown there can collect OTC. Not every branch of an authorized bank handles GST collection, so confirm before visiting.
...
Short answer: हाँ, आप GST cheque से pay कर सकते हैं — पर सिर्फ़ bank counter पर, सिर्फ़ ₹10,000 per challan तक, और सिर्फ़ अगर bank authorized collecting agent है. इससे बड़े amount के लिए, GST portal effectively आपको electronic rails पर force कर देता है — NEFT, RTGS, net banking, debit/credit card, या UPI.

Long answer ज़्यादा useful है, so यहाँ है.

### [H2] GST Portal पर Mode-of-Payment Picture

जब आप gst.gov.in पर login करते हैं और challan create करते हैं, चार payment modes दिखेंगे:

- **E-payment** — authorized banks के through net banking
- **Over the Counter (OTC)** — authorized bank पर cash, cheque, या demand draft
...
### [H2] ₹10,000 Cap (और Actually इसका मतलब क्या है)
...
### [H2] GST को Cheque से Actually कैसे Pay करें (OTC Walkthrough)

अगर आपकी liability ₹10,000 या उससे कम है और आप genuinely cheque route prefer करते हैं, ये है OTC payment flow:

1. **gst.gov.in पर challan generate करें.** Login → Services → Payments → Create Challan. Heads (CGST, SGST, IGST, Cess) fill करें, mode के तौर पर "Over the Counter" choose करें, dropdown से authorized bank select करें.
...
3. **Printed challan और cheque के साथ chosen authorized bank की branch में जाएँ.** Cheque ये होना चाहिए:
...
### [H2] कौन से Banks GST Collection के लिए Authorized हैं
...
Branch भी matter करती है. Authorized bank की हर branch GST collect नहीं करती. Tier-2 और tier-3 cities में, सिर्फ़ designated "tax-collecting" branches करती हैं — CPIN-printed challan और cheque लेकर walk in करने से पहले call करें.

### [H2] क्यों ज़्यादातर Businesses Cheque Route Skip करते हैं Anyway
...
### [H2] ₹10,000 से ऊपर के Real Alternatives

जब GST portal OTC block कर देता है क्योंकि आपकी liability cap से ऊपर है, चार electronic options हैं:

- **E-payment (net banking)** — fastest अगर आपका bank authorized list पर है. CIN आपके Electronic Cash Ledger में usually seconds में appear होता है.
...
### [H2] जब Cheque-via-OTC Genuinely Help करता है
...
### [H2] OTC के लिए भी Cheque Quality Still Matters
...
> **Disclosure:** GST rules CBIC द्वारा circular से issue और revise होते हैं. Actual payment से पहले thresholds और authorized-bank lists GST portal पर verify करें. ये article informational है और practising chartered accountant की advice का substitute नहीं है.
...
### [H2] GST Portal પર Mode-of-Payment Picture
...
### [H2] ₹10,000 Cap (અને Actually આનો અર્થ શું છે)
...
### [H2] GST ને Cheque થી Actually કેવી રીતે Pay કરવો (OTC Walkthrough)

જો તમારી liability ₹10,000 કે એનાથી ઓછી છે અને તમે genuinely cheque route prefer કરો છો, આ રહ્યો OTC payment flow:

1. **gst.gov.in પર challan generate કરો.** Login → Services → Payments → Create Challan. Heads (CGST, SGST, IGST, Cess) fill કરો, mode તરીકે "Over the Counter" choose કરો, dropdown થી authorized bank select કરો.
...
3. **Printed challan અને cheque સાથે chosen authorized bank ની branch માં જાઓ.** Cheque આ હોવો જોઈએ:
...
### [H2] કયા Banks GST Collection માટે Authorized છે
...
### [H2] કેમ મોટાભાગના Businesses Cheque Route Skip કરે છે Anyway
...
### [H2] ₹10,000 થી ઉપરના Real Alternatives
...
### [H2] જ્યારે Cheque-via-OTC Genuinely Help કરે છે
...
### [H2] OTC માટે પણ Cheque Quality Still Matters
...
> **Disclosure:** GST rules CBIC દ્વારા circular થી issue અને revise થાય છે. Actual payment પહેલા thresholds અને authorized-bank lists GST portal પર verify કરો. આ article informational છે અને practising chartered accountant ની advice નો substitute નથી.
...
- **Tax-rules fact check (CRITICAL):** verify the ₹10,000 OTC cap, authorized-bank list, and challan flow against current gst.gov.in Help and recent CBIC circulars. The disclosure paragraph in the body is mandatory.
