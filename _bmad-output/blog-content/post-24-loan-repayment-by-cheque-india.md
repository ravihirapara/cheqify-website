...
RBI and NPCI have been pushing lenders off PDCs and onto e-NACH / NACH mandates for years — NPCI even issued a specific circular on migrating PDC/EMI cheques to NACH Debit. So the PDC's role has shrunk from "the actual payment method" to "the security blanket". (For the full rulebook on PDCs, see [post-dated cheques: rules and best practices](/en/blog/post-dated-cheques-rules-and-best-practices).)
...
Until then, interest keeps accruing on the un-reduced balance. Historically that meant a T+1 or T+2 wait. Good news — India moved to **continuous cheque clearing** under CTS from **4 October 2025**, so a cheque presented in the 10 AM–4 PM window can now clear and credit **same day**. (The mechanics: [cheque clearing time in India](/en/blog/cheque-clearing-time-india) and the [truncation system explained](/en/blog/cheque-truncation-system-explained).)
...
**इसे A/c Payee Only cross करें.** Top-left corner में two parallel lines, बीच में "A/c Payee Only" लिखा. ये sure करता है कि ये सिर्फ़ named account में credit हो सकता है, counter पर कभी cash नहीं. (अगर इस पर आप shaky हैं, यहाँ है [account-payee crossing breakdown](/hi/blog/crossed-cheque-vs-account-payee) और [full fill-it-correctly guide](/hi/blog/how-to-fill-cheque-correctly).)
...
RBI और NPCI सालों से lenders को PDCs से हटाकर e-NACH / NACH mandates पर push कर रहे हैं — NPCI ने तो PDC/EMI cheques को NACH Debit पर migrate करने पर एक specific circular भी issue किया. तो PDC का role "actual payment method" से shrink होकर "security blanket" हो गया है. (PDCs पर full rulebook के लिए, देखें [post-dated cheques: rules and best practices](/hi/blog/post-dated-cheques-rules-and-best-practices).)
...
तब तक, interest un-reduced balance पर accrue होता रहता है. Historically इसका मतलब एक T+1 या T+2 wait था. Good news — India **4 October 2025** से CTS के under **continuous cheque clearing** पर move हो गया, so 10 AM–4 PM window में present किया गया cheque अब **same day** clear और credit हो सकता है. (Mechanics: [cheque clearing time in India](/hi/blog/cheque-clearing-time-india) और [truncation system explained](/hi/blog/cheque-truncation-system-explained).)
...
**એને A/c Payee Only cross કરો.** Top-left corner માં two parallel lines, વચ્ચે "A/c Payee Only" લખેલું. આ sure કરે છે કે એ ફક્ત named account માં credit થઈ શકે, counter પર ક્યારેય cash નહીં. (જો આના પર તમે shaky હો, અહીં છે [account-payee crossing breakdown](/gu/blog/crossed-cheque-vs-account-payee) અને [full fill-it-correctly guide](/gu/blog/how-to-fill-cheque-correctly).)
...
RBI અને NPCI વર્ષોથી lenders ને PDCs થી હટાવીને e-NACH / NACH mandates પર push કરી રહ્યા છે — NPCI એ તો PDC/EMI cheques ને NACH Debit પર migrate કરવા પર એક specific circular પણ issue કર્યો. તો PDC નો role "actual payment method" થી shrink થઈને "security blanket" થઈ ગયો છે. (PDCs પર full rulebook માટે, જુઓ [post-dated cheques: rules and best practices](/gu/blog/post-dated-cheques-rules-and-best-practices).)
